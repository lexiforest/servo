...
impl WebStorageTest {
    pub(crate) fn new() -> Self {
        ...
        let threads = storage::new_storage_threads(mem_profiler_chan, Some(config_dir), false, false);
    ...
    pub(crate) fn new_in_memory() -> Self {
        let mem_profiler_chan = profile_mem::Profiler::create(true);
        let threads = storage::new_storage_threads(mem_profiler_chan, None, false, false);
    ...
    pub(crate) fn restart(mut self) -> Self {
        ...
        let mem_profiler_chan = profile_mem::Profiler::create(true);
        let threads = storage::new_storage_threads(mem_profiler_chan, config_dir, false, false);
