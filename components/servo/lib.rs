...
pub use net_traits::{
    ...
    is_bimp_graphics_contexts_disabled, is_bimp_media_requests_disabled,
    is_bimp_webrtc_disabled, remove_bimp_flash_webview, set_bimp_flash_webview,
    set_bimp_network_profile, set_bimp_webview_mode,
};
